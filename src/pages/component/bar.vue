  ...
  <view>
    ...
    <view class="box"
      ...
      <view class="cu-bar justify-center bg-white">
        <view class="action border-title">
          ...
          <text class="bg-gradual-blue"
                style="width:3rem"></text>
        </view>
      </view>
      <view class="cu-bar justify-center bg-white">
    ...
    <view class="box">
      ...
      <view class="cu-bar bg-red search">
        <view class="cu-avatar round"
              style="background-image:url(https://ossweb-img.qq.com/images/lol/web201310/skin/big114004.jpg);"></view>
